...
function EmptyLeg() {
    ...
    const handleSubmit = () => {
        setLoading(true)
        axios
            .post(`http://localhost:8000/api/v1/flight/add`, formData)
            .then((data) => {
                setLoading(false)
                        ...
                        <MDBox pt={4} pb={3} px={3}>
                            ...
                            <MDBox component="form" role="form" gap={"2"}>
                                ...
                                <MDBox mb={2}>
                                    ...
                                    />
                                    <MDTypography fontWeight="500" variant="caption">{val?.label}</MDTypography>
                                ...
                                <MDBox mb={2}>
                                    ...
                                    <Select
                                        ...
                                        getOptionLabel={(option) => option.label}
                                    />
                                    <MDTypography fontWeight="500" variant="caption">{val2?.label}</MDTypography>
                                </MDBox>
                                <MDBox mb={2}>
                                    <label style={{ fontSize: "13px" }}>Departure Date</label>
                                    <MDInput type="date" name="departure_date" onChange={(e) => {
                                        setDepartureDate(e.target.value)
                                    }} fullWidth />
                                </MDBox>
                                <MDBox mb={2}>
                                    <label style={{ fontSize: "13px" }}>Departure Time</label>
                                    <MDInput type="time" name="departure_date" onChange={(e) => {
                                ...
                                <MDBox mb={2}>
                                    ...
                                    <MDInput type="number" name="departure_date" onChange={(e) => {
